"""This is for determination atmospheric throughput of MSE ETC.
...
2021.04.19 - updated by Mingyoeng Yang
...
#==========================================================================================
    ...
    def tau_opt_res(self, wave):
        ...
        self.tau_opt = ENCL_LR * TEL_MSTR_LR * func_tel_m1_zecoat(wave) * TEL_PFHS_LR * func_tel_wfc_adc(wave) * SIP_POSS_LR * func_sip_fits(wave) * func_sip(wave)
